...
position = Position("Иван", "Петров", "DevOps", 60000, 50000)
print(f"name: {position.name}, surname: {position.surname}, position: {position.position}, wage+bonus: {position.income}")
